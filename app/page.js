  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <span style={{
          fontSize: 11, fontWeight: 700, color: ratingColors[rating],
          background: bgColors[rating], padding: "4px 10px", borderRadius: 20, letterSpacing: 0.5,
        }}>
    ...
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
        <span style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", fontWeight: 500 }}>
          {label} <span style={{ color: "rgba(255,255,255,0.2)" }}>({weight}%)</span>
        </span>
        <span style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", fontWeight: 600 }}>{value}/100</span>
      </div>
      <div style={{ height: 6, background: "rgba(255,255,255,0.06)", borderRadius: 3, overflow: "hidden" }}>
        <div style={{
          height: "100%", width: `${animatedWidth}%`, borderRadius: 3,
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 720, margin: "0 auto", padding: "40px 20px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <div style={{
            ...
            borderRadius: 24, padding: "6px 16px", marginBottom: 20, fontSize: 12,
            color: "#818cf8", fontWeight: 600, letterSpacing: 0.5,
          }}>
          ...
          <h1 style={{
            ...
            background: "linear-gradient(135deg, #f0f0f0 0%, #a5a5a5 100%)",
            WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
          }}>IdeaLens</h1>
          <p style={{ fontSize: 16, color: "rgba(255,255,255,0.4)", marginTop: 10, fontWeight: 400, maxWidth: 400, margin: "10px auto 0" }}>
            Validate your YouTube video ideas with real data before you invest the time.
          </p>
        </div>
        ...
        <div style={{
          ...
          borderRadius: 20, padding: 6, marginBottom: 16, display: "flex",
          boxShadow: "0 4px 24px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.03)",
        }}>
          <input
            ref={inputRef} value={idea}
            onChange={(e) => setIdea(e.target.value)}
            onKeyDown={(e) => e.key === "Enter" && analyze()}
            placeholder="Type a video idea or title..."
            disabled={loading}
            style={{
              flex: 1, background: "transparent", border: "none", outline: "none",
              color: "#f0f0f0", fontSize: 15, padding: "14px 18px",
          ...
          >{loading ? "Analyzing..." : "Validate"}</button>
        </div>
        ...
        {!result && !loading && !error && (
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 32, justifyContent: "center" }}>
            ...
            {EXAMPLE_IDEAS.map((ex) => (
              <button
                key={ex}
                onClick={() => { setIdea(ex); setTimeout(() => analyze(ex), 100); }}
                style={{
                  background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)",
                  borderRadius: 10, padding: "6px 14px", color: "rgba(255,255,255,0.45)",
                  fontSize: 12, cursor: "pointer", fontFamily: "system-ui, -apple-system, sans-serif",
        ...
        {loading && (
          <div style={{ textAlign: "center", padding: "60px 0" }}>
            <div style={{ display: "flex", justifyContent: "center", gap: 6, marginBottom: 24 }}>
              {[0, 1, 2].map((i) => (
                <div key={i} style={{
                  width: 8, height: 8, borderRadius: 4, background: "#6366f1",
            ...
            <div style={{ color: "rgba(255,255,255,0.35)", fontSize: 14, fontWeight: 500 }}>
              Analyzing YouTube data and Google Trends...
            </div>
          </div>
        )}
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 10, padding: "8px 20px", color: "rgba(255,255,255,0.6)",
                fontSize: 13, cursor: "pointer", fontFamily: "system-ui, -apple-system, sans-serif", fontWeight: 500,
              }}
            >Try Again</button>
          </div>
        )}
        ...
        {result && !loading && (
          <div style={{ marginTop: 32 }}>
            ...
            <div style={{
              ...
              borderRadius: 20, padding: "28px 32px", marginBottom: 20, flexWrap: "wrap",
            }}>
            ...
            {result.breakdown && (
              <div style={{
                ...
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.35)", fontWeight: 600, letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 16 }}>
                  Score Breakdown
                </div>
            ...
            <div style={{
              ...
              {["insights", "titles"].map((tab) => (
                ...
                >{tab === "insights" ? "Key Insights" : "Title Suggestions"}</button>
              ))}
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 15, fontWeight: 700, color: "rgba(255,255,255,0.7)", marginBottom: 6 }}>
                Want deeper analysis for your channel?
              </div>
              <div style={{ fontSize: 13, color: "rgba(255,255,255,0.35)", marginBottom: 16 }}>
                Connect your YouTube channel for personalized scoring.
              </div>
              <button style={{
            ...
            <div style={{ textAlign: "center", marginTop: 20 }}>
              <button
                onClick={() => { setResult(null); setIdea(""); inputRef.current?.focus(); }}
                style={{
                  background: "none", border: "none", color: "rgba(255,255,255,0.25)",
                  fontSize: 13, cursor: "pointer", fontFamily: "system-ui, -apple-system, sans-serif",
