...
function MetricCard({ label, value, rating, detail, delay }) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontSize: 22, fontWeight: 700, color: "#f0f0f0" }}>
          {value}
        </span>
        <span
          style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <h1
            style={{
              ...
              lineHeight: 1.15,
              background:
                "linear-gradient(135deg, #f0f0f0 0%, #a5a5a5 100%)",
        ...
        {result && !loading && (
          <div style={{ marginTop: 32 }}>
            ...
            >
              ...
              <MetricCard
                label="Trend"
                value={result.trendDirection.change}
                rating={result.trendDirection.rating}
                detail={result.trendDirection.value}
                delay={440}
              />
              <MetricCard
                label="Title Score"
                value={result.titleScore.value}
                rating={result.titleScore.rating}
                delay={560}
              />
            </div>
            ...
            >
              {["insights", "titles"].map((tab) => (
                ...
                >
                  {tab === "insights" ? "Key Insights" : "Title Suggestions"}
                </button>
              ))}
            </div>
